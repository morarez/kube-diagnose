...
import (
	...
	"github.com/morarez/kube-diagnose/test/utils"
)

// namespace where the project is deployed in
const namespace = "kube-diagnose-system"

// serviceAccountName created for the project
const serviceAccountName = "kube-diagnose-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "kube-diagnose-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "kube-diagnose-metrics-binding"
	...
	ginkgo.Context("Manager", func() {
		...
		ginkgo.It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=kube-diagnose-metrics-reader",
